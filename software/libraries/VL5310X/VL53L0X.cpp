...
//constructor takes the digital pin that the arduino is connected to.
VL53L0X::VL53L0X(int _resetPin)
  : address(ADDRESS_DEFAULT)
  , io_timeout(0)
  , did_timeout(false)
  , resetPin(_resetPin)
...
//if true, reset. Otherwise don't!
void VL53L0X::writeResetPin(bool isReset)
{
    ...
    digitalWrite(resetPin, isReset ? LOW : HIGH); 
}
